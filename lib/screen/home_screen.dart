...
import 'package:flutter_photo/component/main_app_bar.dart';
import 'package:flutter_photo/model/sticker_model.dart';
import 'dart:io';
import 'package:image_picker/image_picker.dart';
import 'package:flutter_photo/component/footer.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  XFile? image; // 사용자가 선택한 이미지 파일
  Set<StickerModel> stickers = {}; // 화면에 추가된 스티커들을 저장
  String? selectedId; // 현재 선택된 스티커의 고유 ID
  GlobalKey imgKey = GlobalKey(); // 이미지 저장을 위해 위젯의 상태를 추적
